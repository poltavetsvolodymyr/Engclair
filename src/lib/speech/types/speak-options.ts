...
export interface VoiceOption {
  /**
   * Identity of the voice, built from more than `voiceURI` — nothing makes
   * that unique on its own. Opaque: only `lib/speech` reads it apart.
   */
  id: string
  /** As the operating system names it, e.g. "Ava". */
  name: string
